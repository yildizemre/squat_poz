...
cap = cv2.VideoCapture("deneme4.mp4")
...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose: # pose objesinin hazırlanması.
    ...
    while cap.isOpened():
        ...
        cv2.rectangle(image, (180, 25), (350,75), (255,174,201), -1)
        cv2.rectangle(image, (180, 25), (350,75), (0,0,255))
        cv2.putText(image,str(counter),(180,60), cv2.FONT_HERSHEY_SIMPLEX, 1,(0,0,255),2,cv2.LINE_AA)
        cv2.putText(image,'tekrar',(240,60), cv2.FONT_HERSHEY_SIMPLEX, 1,(0,0,255),2,cv2.LINE_AA)
